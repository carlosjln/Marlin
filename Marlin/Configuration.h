...
#define STRING_CONFIG_H_AUTHOR "(Prototipo.3D, SKR-3 D-2060)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "D-2060"
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 63.83
  #define DEFAULT_bedKi 11.24
  #define DEFAULT_bedKd 241.70
...
#define DELTA
  ...
  #define DEFAULT_SEGMENTS_PER_SECOND 120
  ...
  #define PRINTABLE_RADIUS 155.0    // (mm)

  // Maximum reachable area
  #define DELTA_MAX_RADIUS       150.0    // (mm)

  // Center-to-center distance of the holes in the diagonal push rods.
  #define DELTA_DIAGONAL_ROD 378.459        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 478.78             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -2.92, 0.00, -0.56 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 209.86              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { 0.07, -0.20, 0.13 } // Get these values from G33 auto calibrate
 ...
 */
 ...
 // 640 = 128 steps
 // 1280 = 256 steps
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 640, 640, 640, 690 } 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 1000, 50 }
 ...
 */
//#define Z_MIN_PROBE_PIN -1 // Z_MIN_PROBE_PIN // PC13
...
#define Z_PROBE_FEEDRATE_SLOW 900 //(Z_PROBE_FEEDRATE_FAST / 2)
